...
<body>
       ...
       <br>
        <div>
          ...
          $sql = $conexao -> query("SELECT servidor.nome, servidor.siape, servidor.telefone, servidor.email, funcoes.ID_funcao FROM servidor 
          INNER JOIN funcoes ON servidor.siape = funcoes.ID_funcao");
